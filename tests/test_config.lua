...
-- test 1: defaults unchanged after empty merge
...
assert_eq(#opts.dapui.layouts, 2, "default layout count")

-- test 2: partial key override
...
-- test 3: disable a key with false
...
-- test 5: merge doesn't mutate defaults
