...
assert_eq(opts.global_keys.breakpoint, "<leader>dx", "default breakpoint key")
...
-- disable a global key
opts = config.merge({ global_keys = { breakpoint = false } })
assert_eq(opts.global_keys.breakpoint, false, "disabled breakpoint key")
